...
try {
    ...
    if (!$canView) {
        Response::error('Cannot view following list for private account', 403);
    }
    
    // Get total following count
    $countStmt = $db->prepare("SELECT COUNT(*) as total FROM followers WHERE follower_id = ?");
    ...
    Response::success(Response::pagination($following, $total, $page, $limit));
